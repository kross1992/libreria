 ...
 */
final class Version20210415213845 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE libro (id INT AUTO_INCREMENT NOT NULL, titulo VARCHAR(100) NOT NULL, descripcion VARCHAR(9999) NOT NULL, fecha_publicacion DATE NOT NULL, idioma VARCHAR(10) NOT NULL, autor VARCHAR(255) DEFAULT NULL, cantidad_paginas INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
